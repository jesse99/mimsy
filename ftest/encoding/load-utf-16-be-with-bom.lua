-- Verify that Mimsy is able to load text documents formatted as utf-16 big endian
...
local fname = '/tmp/utf-16-be-bom.txt'
local file = io.open(fname, 'w')
file:write('\254\255\0H\0e\0l\0l\0o\32\34\0W\0o\0r\0l\0d')	-- 'Hello World' with a bullet
file:close(file)
